...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'DGTI Formation'); ?></title>
    ...
    <style id="drapeau-style">
        body::before {
            ...
            width: 100vw;
            height: 100vh;
            background: url('<?php echo e(asset('assets/img/imagg.png')); ?>') no-repeat center center fixed;
...
<body>
    <div class="topbar">
        <div class="d-flex align-items-center gap-3">
            <img src="<?php echo e(asset('assets/img/image.png')); ?>" alt="Logo" class="logo">
        ...
        <div>
            ...
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-light btn-sm">Se connecter</a>
                <a href="<?php echo e(route('register')); ?>" class="btn btn-outline-light btn-sm ms-2">S’inscrire</a>
            <?php endif; ?>
        </div>
    </div>
        ...
        <?php if(auth()->guard()->check()): ?>
            <aside class="sidebar">
                <nav>
                    ...
                    <a href="<?php echo e(route('commentaires.index')); ?>">💬 Commentaires</a>

                    <?php if(Auth::user()->isAdmin()): ?>
                        <hr>
                        <strong class="d-block px-2 text-muted">👑 Admin</strong>
                        <a href="<?php echo e(route('admin.formations.index')); ?>">📊 Gérer les Formations</a>
                        <a href="<?php echo e(route('admin.directions.index')); ?>">🏢 Gérer les Directions</a>
                        <a href="<?php echo e(route('admin.users.index')); ?>">👥 Gérer les Utilisateurs</a>
                    <?php endif; ?>

                    <?php if(Auth::user()->isFormateur()): ?>
                        <hr>
                        <strong class="d-block px-2 text-muted">📘 Formateur</strong>
                        <a href="<?php echo e(route('formateur.formations.index')); ?>">📘 Mes Formations</a>
                    <?php endif; ?>
                    ...
                    <?php if(Auth::user()->isParticipant()): ?>
                        ...
                        <div class="px-3">
                            ...
                            <ul class="submenu list-unstyled ps-4 mt-1" style="display: none;">
                                <li>
                                    <a href="<?php echo e(route('participant.formations.index')); ?>">📝 S’inscrire à une Formation</a>
                                </li>
                            </ul>
                        </div>
                    <?php endif; ?>
    ...
    <footer class="footer">
        <div>
            <img src="<?php echo e(asset('assets/img/immm.png')); ?>" alt="Drapeau Burkina Faso" style="height: 20px; vertical-align: middle;">
